...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help ="Name for the cleaned dataset to upload to W&B",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help ="Minimum acceptable price to include in the dataset",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type =float,
        help ="Maximum acceptable price to include in the dataset",
        required = True
    )
